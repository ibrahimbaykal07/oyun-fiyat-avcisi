...
PAGE_SIZE = 12
PLACEHOLDER_IMG = "https://placehold.co/600x900/222/FFF/png?text=Resim+Yok"
...
def fetch_sub_games(sub_name, page=0, page_size=12):
    ...
    results = []
    for name in batch:
        # Manuel oluşturulmuş oyun objesi
        game_obj = {
            "title": name,
        ...
        try:
            # API'den veri çekmeye çalış (Sade isimle)
